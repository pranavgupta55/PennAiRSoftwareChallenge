...
#         gray compared to the trapezoid so it can be used effectively in the next step (this is why the HSV mask was grayscaled and not just kept as a binary img).
...
#     along with some calculated data like an index and the polygon's center
#
#
